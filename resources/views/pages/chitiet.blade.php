...
<section id="body">
				...
				<div class="uk-grid uk-grid-medium">
					...
					<div class="uk-width-large-2-5">
						<div class="prd-desc">
							...
							<p class="address"><i>{{$singleproduct->address}}, {{$singleproduct->district->name}}, {{$singleproduct->district->city->name}}</i></p>
							<p class="price"> @if($singleproduct->price) Giá: <span>{{$singleproduct->price}}</span> @else Giá: <span>Liên hệ</span> @endif</p>
    ...
    border-radius: 5px;}
						...
						<div class="prd-content" id='dang-ky'>
							<ul class="uk-list uk-clearfix nav-tabs" data-uk-switcher="{connect:'#tabContent'}">
								<li style='text-align: center;float: inherit;' class="uk-active" aria-expanded="true">Đăng Ký Nhận Chọn Căn Đẹp Giá Tốt</li>
							</ul>
							<ul id="tabContent" class="uk-switcher tab-content">
										...
										<div class="dat-cho">
											<div class="uk-grid ">
												<div class="uk-width-large-1-2">
													<div> <span>Quý khách hàng vui lòng điền đầy đủ thông tin để nhận báo giá và ưu đãi chọn căn đẹp !</span>
													<ul>
														<li class="first">Ưu tiên chọn <b>căn đẹp</b></li>
														<li>Chương trình ưu đãi <b>tốt</b></li>
														<li>Chương trình <b>Ưu đãi</b> khuyến mại</li>
														<li>Tư vấn <b>tận tâm</b> quy hoạch vân đồn</li>
														<li class="last">Bảng báo giá chi tiết <b>từng lô đất</b></li>
													</ul>
													</div>
												</div>
												<div class="uk-width-large-1-2">
