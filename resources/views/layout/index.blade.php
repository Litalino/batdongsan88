...
@media (max-width: 479px) {
	.chinh-sach .fa-gift{display: none;}
	.chinh-sach h2 {line-height: 30px;}
	.chinh-sach .chinh-sach-content{padding: 0 10px;}
	.chinh-sach{padding: 10px 15px;}
	.chinh-sach p, .chinh-sach ul li{line-height: 29px;}
}
</style>
